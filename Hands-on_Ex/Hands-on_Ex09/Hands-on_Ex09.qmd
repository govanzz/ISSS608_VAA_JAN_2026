---
title: "Hands on Exercise 9 Visualising Network Data"
author: "Gautamgovan"
date: "March 4, 2026"
...
- **`as_tbl_graph()`**  
  Converts network data and objects into a `tbl_graph` network.

### Network data and objects supported by `as_tbl_graph()`
...
- `graphNEL`, `graphAM`, `graphBAM` from **graph** (Bioconductor)
