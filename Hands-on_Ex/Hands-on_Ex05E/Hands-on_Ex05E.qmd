...
Before we get started, we are required to check if treemap and tidyverse pacakges have been installed in  R.
```{r}
...
1. If this is the first time we will install a package from GitHub, you should install **devtools** package by using the code below or else you can skip this step.
