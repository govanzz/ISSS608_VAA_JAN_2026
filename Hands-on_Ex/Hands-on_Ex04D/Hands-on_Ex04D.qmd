---
title: "Hands on Exercise 4D: Funnel Plots"
author: "Gautamgovan"
...
The **FunnelPlotR** package uses **ggplot2** to generate funnel plots. It requires a **numerator** (events of interest), a **denominator** (population to be considered), and a **group** variable. The key arguments available for customisation are:
...
-   **xrange** and **yrange**: specify the display range for the axes (acts like a zoom function).
-   Other aesthetic components such as graph title and axis labels.
...
-   **group** in this function is different from the scatterplot. Here, it defines the level of the points to be plotted (e.g., sub-district, district, or city). If *City* is chosen, there are only six data points.
-   By default, the **data_type** argument is `"SR"`.
-   **limit**: plot limits; accepted values are 95 or 99, corresponding to the 95% or 99.8% quantiles of the distribution.
...
-   **title**: used to add a plot title.
-   **x_label** and **y_label**: used to add or edit the x-axis and y-axis titles.
