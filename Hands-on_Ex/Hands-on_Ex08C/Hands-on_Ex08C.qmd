...
Firstly, we will write an R function as shown below to extract a variable  
(i.e. `wp_nonfunctional`) as a vector out of an `sf` data frame.
...
- **returns:**
  - `bb`: vector with 7 break points computed from quartiles and fences
